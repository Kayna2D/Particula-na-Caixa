...
tk.Radiobutton(root, text="Massa do próton", variable=massa, value="mp").grid(row=7, column=1)
tk.Radiobutton(root, text="Massa do elétron", variable=massa, value="me").grid(row=8, column=1)

tk.Button(root, text="Calcular", command=0).grid(row=9, column=0, columnspan=2, padx=10, pady=10)
